...
import { AdminLayout } from '@/components/materials';
...
console.log('themeStore.layout.mode.includes(vertical)', themeStore.layout.mode.includes('vertical'));
...
<template>
  <AdminLayout v-model:sider-collapse="appStore.siderCollapse" :mode="layoutMode" scroll-el-id="__SCROLL_EL_ID__"
